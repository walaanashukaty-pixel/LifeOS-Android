-- LifeOS existing-project repair patch
-- Run once in the Supabase SQL Editor if the original 20260101000000 migration
-- was already applied before this repair. The statements are idempotent.
