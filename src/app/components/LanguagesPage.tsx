...
export function LanguagesPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      {/* New Language Form */}
      {showLangForm && (
        <FormModal open={showLangForm} title={'إضافة لغة جديدة'} onClose={() => setShowLangForm(false)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
          ...
          {selected && (
            <div className="lg:col-span-3 space-y-4">
              ...
              {/* Add Item Form */}
              {showItemForm && (
                <FormModal open={showItemForm} title={tab === 'vocab' ? 'إضافة مفردة' : tab === 'grammar' ? 'إضافة قاعدة' : 'إضافة محادثة'} onClose={() => setShowItemForm(false)}>
