  ...
  return (
    <div className="lifeos-page-shell max-w-5xl mx-auto space-y-6">
      ...
      {showForm && (
        ...
        <div className="bg-card rounded-2xl border border-primary/30 p-5 pt-7 space-y-4 shadow-xl shadow-primary/5">
          <div>
            <h3 className="font-bold text-foreground text-base">
              {editTask ? '✏️ تعديل المهمة' : '✨ إضافة مهمة جديدة'}
            </h3>
            <p className="mt-1 text-[11px] leading-5 text-muted-foreground">اكتب اسم المهمة ثم اضبط التفاصيل التي تحتاجها فقط.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onKeyDown={e => { if (e.key === 'Enter' && !e.nativeEvent.isComposing) { e.preventDefault(); void saveTask(); } }}
