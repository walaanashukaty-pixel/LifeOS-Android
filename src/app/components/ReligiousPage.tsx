    ...
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      {tab === 'dhikr' && (
        <div className="space-y-4">
          ...
          {showDhikrForm && (
            <FormModal open={showDhikrForm} title={'إضافة ذكر'} onClose={() => setShowDhikrForm(false)}>
      ...
      {tab === 'memorization' && (
        <div className="space-y-4">
          ...
          {showMemForm && (
            <FormModal open={showMemForm} title={'إضافة سجل حفظ'} onClose={() => setShowMemForm(false)}>
            <div className="bg-card rounded-2xl border border-primary/30 p-5 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-medium mb-1.5">السورة</label>
      ...
      {tab === 'lessons' && (
        <div className="space-y-4">
          ...
          {showLessonForm && (
            <FormModal open={showLessonForm} title={'إضافة درس ديني'} onClose={() => setShowLessonForm(false)}>
            <div className="bg-card rounded-2xl border border-primary/30 p-5 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
